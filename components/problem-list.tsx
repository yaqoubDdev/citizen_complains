...
import { ArrowBigUp, MessageSquare, Lightbulb, Trash2, Shield, HelpCircle } from "lucide-react"
...
const categoryConfig = {
    infrastructure: { label: "Road/Light", icon: Lightbulb, color: "bg-blue-100 text-blue-800" },
    sanitation: { label: "Trash", icon: Trash2, color: "bg-green-100 text-green-800" },
    ...
    return (
        <div className="space-y-6">
            {problems.map((problem) => {
                const config = categoryConfig[problem.category] || categoryConfig.other
